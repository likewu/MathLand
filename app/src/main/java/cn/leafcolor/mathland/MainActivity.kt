...
class MainActivity : AppCompatActivity(), SessionListFragment.SessionSelection, AppsListFragment.AppSelection, FilesystemListFragment.FilesystemListProgress {
    ...
    private val viewModel: MainActivityViewModel by lazy {
        ...
        val assetRepository = AssetRepository(ulaFiles, this.getAssets(), filesDir.path, assetPreferences, githubApiClient)
    ...
    private fun sendWikiIntent() {
        val intent = Intent("android.intent.action.VIEW", Uri.parse("https://github.com/likewu/MathLand/wiki"))
        startActivity(intent)
    }
